...
public class ModifyAppointmentViewController implements Initializable {
        ...
        switch (caseInt) {
            ...
            case 6:
                try {
                    ...
                    System.out.println(Util.hasOverlap(proposedAppt));

                    if (!Util.hasOverlap(proposedAppt)) {
                        boolean saveSuccess = Appointment.updateAppointmentInDB(index, proposedAppt);
    ...
    /** Initializes Modify Appointment screen. Sets titles, and items inside combo boxes */
    @Override
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        mainIDLabel.setText(String.valueOf(displayedAppointment.getID()));
        IDField.setText(String.valueOf((displayedAppointment.getID())));
        IDField.setDisable(true);
        titleField.setText(String.valueOf(displayedAppointment.getTitle()));
        descriptionField.setText(String.valueOf(displayedAppointment.getDescription()));
        locationField.setText(displayedAppointment.getLocation());
        typeField.setText(String.valueOf(displayedAppointment.getType()));

        startDatePicker.setValue(displayedAppointment.getStart().toLocalDate());
        startHourCBO.setValue(String.valueOf(displayedAppointment.getStart().getHour()));
        startMinCBO.setValue(String.valueOf(displayedAppointment.getStart().getMinute()));
        endDatePicker.setValue(displayedAppointment.getEnd().toLocalDate());
        endHourCBO.setValue(String.valueOf(displayedAppointment.getEnd().getHour()));
        endMinCBO.setValue(String.valueOf(displayedAppointment.getEnd().getMinute()));
        userIDField.setText(String.valueOf((displayedAppointment.getUserID())));


        customerCombo.setValue(displayedAppointment.getCustomerID());
        customerCombo.setItems(Util.getAllCustomersDataBase());

        contactCombo.setValue(displayedAppointment.getContactName());
